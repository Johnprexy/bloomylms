...
import { LayoutDashboard, BookOpen, GraduationCap, Award, User, LogOut, ChevronLeft, ChevronRight, Users, BarChart3, DollarSign, PlusCircle, Settings, Video } from 'lucide-react'
...
export default function Sidebar({ profile }: { profile: any }) {
  ...
  return (
    <aside className={cn('bg-white border-r border-gray-100 flex flex-col transition-all duration-300 relative', collapsed ? 'w-16' : 'w-64')}>
      ...
      {!collapsed && (
        <div className="px-4 py-3 border-b border-gray-50">
          <span className={cn('text-xs font-semibold px-2 py-1 rounded-full',
            ...
            profile.role === 'instructor' ? 'bg-purple-50 text-purple-700' : 'bg-green-50 text-green-700')}>
      ...
      <div className="border-t border-gray-100 p-3 space-y-1">
        ...
        <button
          ...
          className={cn('sidebar-link w-full text-red-500 hover:bg-red-50 hover:text-red-600', collapsed && 'justify-center px-2')}>
